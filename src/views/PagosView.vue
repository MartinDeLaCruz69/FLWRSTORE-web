  ...
  <div class="pagos-page">
    ...
    <section class="page-hero">
      ...
      <div class="page-hero__content">
        ...
        <h1>
          Formas de pago &<br /><span class="text-pink">Flujo de compra</span>
        </h1>
    ...
    <div class="pagos-content">
      <!-- Métodos de pago -->
      <div class="section-label fade-up" :class="{ visible: v1 }">
        💳 Métodos aceptados
      </div>
      <div
        class="payment__grid fade-up delay-1"
        :class="{ visible: v1 }"
        ref="r1"
      >
        <div class="payment__card payment__card--spei">
          ...
          <p>
            Transferencia bancaria directa desde cualquier banco mexicano.
            Rápida y segura.
          </p>
        ...
        <div class="payment__card payment__card--oxxo">
          ...
          <p>
            Paga en efectivo en cualquier tienda OXXO de México. <br />
            O si lo prefieres, puedes pagar en efectivo presencialmente, sin
            necesidad de tener cuenta bancaria.
          </p>
      ...
      <div class="info-note fade-up delay-2" :class="{ visible: v1 }">
        <span>ℹ️</span>
        <p>
          Los datos de cuenta para SPEI y OXXO se envían directamente al
          confirmar tu pedido por <strong>WhatsApp</strong>. Así garantizamos la
          seguridad de tu información.
        </p>
      </div>

      <!-- Flujo de compra paso a paso -->
      <div class="section-label fade-up" :class="{ visible: v2 }" ref="r2">
        🛍️ ¿Cómo comprar?
      </div>
      ...
      <!-- Reglas de apartado -->
      <div class="section-label fade-up" :class="{ visible: v3 }" ref="r3">
        📌 Reglas de apartado
      </div>
      <div class="rules__grid fade-up delay-1" :class="{ visible: v3 }">
        <div class="rule__card">
          ...
          <div>
            ...
            <p>
              Tienes 24 horas para completar el pago desde que apartas. Después,
              el producto regresa a stock.
            </p>
          </div>
        </div>
        <div class="rule__card rule__card--highlight">
          ...
          <div>
            ...
            <p>
              Para pedidos mayores a $550 MXN puedes dar un anticipo del 20% y
              acordar el resto con la administradora.
            </p>
          </div>
        </div>
        <div class="rule__card">
          ...
          <div>
            ...
            <p>
              Una vez realizado el pago no se aceptan cancelaciones ni se
        ...
        <div class="rule__card">
          ...
          <div>
            ...
            <p>
              Tu compra queda confirmada únicamente a través del canal oficial
              de WhatsApp.
            </p>
          </div>
        </div>
      ...
      <div class="pagos__cta fade-up" :class="{ visible: v3 }">
        ...
        <div class="pagos__cta-btns">
          <router-link to="/stock" class="btn-primary"
            >🛍️ Ver Stock disponible</router-link
          >
          <a
            href="https://chat.whatsapp.com/Le9ZLZRUiT02x0MbJh86mW?mode=gi_t"
            target="_blank"
            class="btn-primary"
            >💬 Ir al canal de WhatsApp</a
          >
        </div>
      </div>
    </div>
...
.step__card:hover {
  transform: translateY(-6px);
  box-shadow: 0 14px 40px rgba(233, 30, 140, 0.14);
}
.step__number {
  position: absolute;
  top: -12px;
...
.rule__card {
  ...
  padding: 22px 20px;
  border: 1.5px solid rgba(233, 30, 140, 0.1);
  box-shadow: 0 4px 16px rgba(233, 30, 140, 0.05);
  transition: transform 0.3s;
}
.rule__card:hover {
