  ...
  <div class="apartados-page">
    ...
    <div class="apartados-content">
      ...
      <div v-else-if="misApartados.length === 0" class="empty-state">
        ...
        <p>
          Cuando apartes algo aparecerá aquí con el tiempo restante para pagar.
        </p>
        ...
        >
          ...
          <div class="apartado-card__img">
            <img
              ...
              :alt="prod.nombre"
            />
            <span v-else class="apartado-card__emoji">{{
          ...
          <div class="apartado-card__body">
            ...
            <!-- Inclusiones -->
            <div
              v-if="prod.inclusiones?.length"
              class="apartado-card__inclusiones"
            >
              <span class="detail-label">🎁 Inclusiones</span>
              <div class="inclusion-tags">
                <span
                  v-for="inc in prod.inclusiones"
                  :key="inc"
                  class="inclusion-tag"
                  >{{ inc }}</span
                >
            ...
            <!-- Countdown -->
            <div
              class="apartado-card__timer"
              :class="timerClass(prod.fechaApartado)"
            >
              <span class="timer-icon">⏱️</span>
              <div>
                <span class="timer-label">Tiempo restante para pagar</span>
                <strong class="timer-value">{{
                  calcularTiempoRestante(prod.fechaApartado)
                }}</strong>
              </div>
            </div>
            ...
            <div class="whatsapp-actions">
              ...
              <a
                href="https://chat.whatsapp.com/Le9ZLZRUiT02x0MbJh86mW"
                target="_blank"
                class="btn-whatsapp-grupo"
              >
            ...
            <p class="apartado-card__nota">
              ⚠️ Si no se completa el pago en 24h, el producto puede regresar a
              stock.
            </p>
          </div>
        </div>
      ...
      <div v-if="misApartados.length > 0" class="apartados-info">
        <div class="info-item">
          <span>📋</span>
          <p>
            Todos los pagos se confirman únicamente por
        ...
        <div class="info-item">
          <span>🔒</span>
          <p>
            No se aceptan cancelaciones una vez realizado el pago. A menos que
            se den otras indicaciones por los administradores
          </p>
        </div>
        <div class="info-item">
          <span>💳</span>
...
.apartado-card__anticipo strong {
  color: #c2185b;
}
