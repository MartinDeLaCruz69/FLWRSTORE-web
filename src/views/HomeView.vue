  ...
  <div class="home">
      ...
      <div class="hero__content fade-up" :class="{ visible: heroVisible }">
        <h1 class="hero__title">
          ...
          <span class="hero__brand"
            >FLWR<span class="hero__brand-icon">🌸</span>STORE</span
          >
        </h1>
        <p class="hero__sub">
        ...
        <div class="hero__ctas">
          <router-link to="/stock" class="btn-primary btn-lg"
            >Ver Stock disponible</router-link
          >
          <a
            href="#quienes-somos"
        ...
        <div class="hero__stats">
          <div class="stat">
            <strong>+500</strong><span>Pedidos entregados</span>
          </div>
          <div class="stat-divider"></div>
          <div class="stat">
            <strong>99%</strong><span>Clientes felices</span>
          </div>
          <div class="stat-divider"></div>
          <div class="stat">
            <strong>+2 años</strong><span>En el mercado</span>
          </div>
        </div>
      </div>
        ...
        <div class="hero__card-stack">
          <div class="card-float card-float--back">
            <div class="card-img-wrap">
              <img
                v-if="heroCards[2].img"
                :src="heroCards[2].img"
                :alt="heroCards[2].label"
                class="card-img"
              />
          ...
          <div class="card-float card-float--mid">
            <div class="card-img-wrap">
              <img
                v-if="heroCards[1].img"
                :src="heroCards[1].img"
                :alt="heroCards[1].label"
                class="card-img"
              />
              <div v-else class="card-img-placeholder">
                {{ heroCards[1].emoji }}
          ...
          <div class="card-float card-float--front">
            <div class="card-img-wrap">
              <img
                v-if="heroCards[0].img"
                :src="heroCards[0].img"
                :alt="heroCards[0].label"
                class="card-img"
              />
              <div v-else class="card-img-placeholder">
                {{ heroCards[0].emoji }}
    ...
    <section id="quienes-somos" class="section section--cream" ref="quienesRef">
      <div class="section__inner">
        <div class="section__tag fade-up" :class="{ visible: quienesVisible }">
          💗 Nuestra historia
        </div>
        <h2
          class="section__title fade-up delay-1"
          :class="{ visible: quienesVisible }"
        >
          ¿Quiénes somos?
        </h2>
        <div class="about__grid">
          <div
            class="about__text fade-left"
            :class="{ visible: quienesVisible }"
          >
            <p>
              Somos <strong>FLWRSTORE</strong>, una tienda de mercancía de K-Pop
              nacida del amor por la música y la cultura coreana. Comenzamos
              compartiendo álbumes y photocards entre amigos, y poco a poco
              crecimos hasta convertirnos en un espacio de confianza para fans
              de toda la república.
            </p>
            <p>
              Cada producto que ofrecemos ha sido cuidadosamente seleccionado
              por ti y para tí. Nos aseguramos de entregarte tu pedido en buenas
              condiciones, con el mismo amor con el que fue elegido.
            </p>
            <p>Más que una tienda, somos una gran comunidad 🌸</p>
            <div class="about__values">
              <div
                class="value-pill fade-up delay-1"
                :class="{ visible: quienesVisible }"
              >
                🎁 Empaque seguro
              </div>
              <div
                class="value-pill fade-up delay-2"
                :class="{ visible: quienesVisible }"
              >
                💌 Atención personalizada
              </div>
              <div
                class="value-pill fade-up delay-3"
                :class="{ visible: quienesVisible }"
              >
                ⚡ Entregas personales y por correo
              </div>
              <div
                class="value-pill fade-up delay-4"
                :class="{ visible: quienesVisible }"
              >
    ...
    <section class="section section--white" ref="equipoRef">
      <div class="section__inner">
        <div class="section__tag fade-up" :class="{ visible: equipoVisible }">
          👥 Nuestro equipo
        </div>
        <h2
          class="section__title fade-up delay-1"
          :class="{ visible: equipoVisible }"
        >
          Tú formas parte de nosotros
        </h2>
        <p
          class="section__desc fade-up delay-2"
          :class="{ visible: equipoVisible }"
        >
        ...
        <div class="org__tree">
          <div
            class="org__level fade-up delay-1"
            :class="{ visible: equipoVisible }"
          >
          ...
          <div
            class="org__connector fade-up"
            :class="{ visible: equipoVisible }"
          ></div>
          <div
            class="org__level org__level--two fade-up delay-2"
            :class="{ visible: equipoVisible }"
          >
            <div class="org__card">
              <div class="org__avatar">🎀</div>
          ...
          ></div>
          <div
            class="org__level fade-up delay-3"
            :class="{ visible: equipoVisible }"
          >
    ...
    <section class="section section--pink" ref="redesRef">
      <div class="section__inner">
        <div class="section__tag fade-up" :class="{ visible: redesVisible }">
          📱 Síguenos
        </div>
        <h2
          class="section__title fade-up delay-1"
        ...
        <p
          ...
          :class="{ visible: redesVisible }"
        >
          Estamos activos todos los días. Dentro de nuestro horario de atención,
          sigue nuestro contenido, entérate de lo nuevo y hazte parte de la
          comunidad.
        </p>
    ...
    <section class="section section--white" ref="clientesRef">
      <div class="section__inner">
        <div class="section__tag fade-up" :class="{ visible: clientesVisible }">
          💖 Comunidad
        </div>
        <h2
          class="section__title fade-up delay-1"
        ...
        <div
          ...
          class="testimonials__empty fade-up delay-2"
          :class="{ visible: clientesVisible }"
        >
          <span>🌸</span>
              ...
              >
                ...
                >
                  <div class="testimonial__img-wrap">
                    ...
                    <div
                      v-else
                      class="testimonial__img testimonial__img--placeholder"
                    >
                      {{ t.emoji || "🌸" }}
                    </div>
                  </div>
        ...
        <div
          v-if="esAdmin"
          class="admin__panel fade-up delay-3"
          :class="{ visible: clientesVisible }"
        >
          ...
          <div class="admin__form">
            <div class="admin__form-row">
              <input
                v-model="nuevoTestimonio.name"
                placeholder="Nombre del cliente *"
                class="admin__input"
              />
              <input
                v-model="nuevoTestimonio.location"
                placeholder="Ciudad"
                class="admin__input"
              />
            </div>
            <input
              v-model="nuevoTestimonio.product"
              placeholder="Producto comprado"
              class="admin__input"
            />
            <textarea
              v-model="nuevoTestimonio.text"
            ...
            >
              ...
              <img
                ...
                :src="fotoPreview"
                alt="Preview"
                class="admin__upload-preview"
              />
              <button
                v-if="fotoPreview"
                class="admin__upload-remove"
            ...
            <div class="admin__form-footer">
              <span class="char-count"
                >{{ nuevoTestimonio.text.length }}/200</span
              >
              <button
                class="btn-primary"
                @click="agregarTestimonio"
                :disabled="
                  !nuevoTestimonio.name ||
                  !nuevoTestimonio.text.trim() ||
                  guardandoTestimonio
                "
              >
          ...
          <div v-if="testimonials.length > 0" class="admin__testimonios-lista">
            <p class="admin__lista-titulo">
              📋 Testimonios publicados ({{ testimonials.length }})
            </p>
            <div
              v-for="t in testimonials"
              :key="t.id"
              class="admin__testimonio-item"
            >
              ...
              <button
                class="admin__testimonio-delete"
                @click="eliminarTestimonio(t.id)"
                title="Eliminar"
              >
                🗑️
              </button>
    ...
    <section class="section section--review" ref="comentariosRef">
      <div class="section__inner">
        <!-- FORM para clientes logueados -->
        <div
          v-if="usuarioActual && !esAdmin"
        ...
        >
          ...
          <div class="comment__form-inner">
            ...
            <div class="comment__form-footer">
              <span class="char-count"
                >{{ nuevoComentario.texto.length }}/300</span
              >
              <button
                class="btn-primary"
        ...
        >
          ...
          <!-- Sin comentarios -->
          <div
            v-if="comentariosFiltrados.length === 0"
            class="comment__admin-empty"
          >
            <span>💬</span>
            <p>
              {{
          ...
          <div v-else class="comment__admin-list">
            ...
            >
              <div class="comment__admin-item-header">
                <div class="comment__admin-avatar">
                  {{ c.nombreAutor?.charAt(0).toUpperCase() }}
                </div>
                <div>
              ...
              <button
                v-if="!c.leido"
                class="btn-marcar-leido"
                @click="marcarLeidoHandler(c.id)"
              >
                ✓ Marcar como leído
              </button>
            </div>
        ...
        <div
          v-else-if="!usuarioActual"
          class="comment__login-prompt fade-up"
          :class="{ visible: comentariosVisible }"
        >
          <span>🌸</span>
          <p>
    ...
    <section class="section section--cream-alt" ref="mapaRef">
      <div class="section__inner">
        <div class="section__tag fade-up" :class="{ visible: mapaVisible }">
          🚚 Entregas
        </div>
        <h2
          class="section__title fade-up delay-1"
          :class="{ visible: mapaVisible }"
        >
          ¿Dónde entregamos?
        </h2>
        <p
          ...
          :class="{ visible: mapaVisible }"
        >
          Entregamos en Aguascalientes y enviamos a toda la república vía
          paquetería.
        </p>
        <div class="delivery__grid">
          <div
            class="delivery__info fade-left"
            :class="{ visible: mapaVisible }"
          >
            <div
              class="delivery__item fade-up"
              v-for="(d, i) in deliveryZones"
              :key="d.zone"
              :class="{ visible: mapaVisible }"
          ...
          <div
            class="delivery__map fade-right"
            :class="{ visible: mapaVisible }"
          >
    ...
    <section class="section section--cta-rose" ref="ctaRef">
      <div
        class="section__inner cta__inner fade-up"
        :class="{ visible: ctaVisible }"
      >
        <span class="big-emoji-cta">🌸</span>
        <h2>¿Lista para tu próxima compra?</h2>
        <p>
          Descubre el stock disponible y aparta lo que más te guste antes de que
          se agote.
        </p>
        <router-link to="/stock" class="btn-cta-rose btn-lg"
          >Ver Stock disponible →</router-link
        >
      </div>
    </section>
...
const quienesRef = ref(null);
const quienesVisible = ref(false);
const equipoRef = ref(null);
const equipoVisible = ref(false);
const redesRef = ref(null);
const redesVisible = ref(false);
const clientesRef = ref(null);
const clientesVisible = ref(false);
...
const deliveryZones = [
  {
    icon: "📍",
    zone: "Entrega personal",
    desc: "Frente al Templo de San José, Lic. Francisco Primo Verdad 205, Zona Centro, Aguascalientes",
  },
  {
    icon: "🛵",
    zone: "Envío local",
    desc: "Por Uber o DiDi dentro de Aguascalientes",
  },
  {
    icon: "📮",
    zone: "Envío nacional",
    desc: "Correos de México o Estafeta vía Lolapay a toda la república",
  },
  {
    icon: "💸",
    zone: "Envío gratis",
    desc: "En compras mayores a $550 MXN dentro de Aguascalientes",
  },
];
const mapUrl =
  "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3701.5!2d-102.29614!3d21.88237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8429ef9c5d7b9fcb%3A0x0!2sLic.+Francisco+Primo+Verdad+205%2C+Zona+Centro%2C+Aguascalientes!5e0!3m2!1ses!2smx!4v1";
...
.home {
  ...
  --text: #1a1a1a;
  --text-light: #555;
  --shadow: 0 20px 60px rgba(233, 30, 140, 0.15);
  overflow-x: hidden;
}
...
.section--cream-alt {
  background: linear-gradient(160deg, #fff8f0 0%, #fdf0f7 100%);
}
.section--cta-rose {
...
.card-float--front {
  ...
  left: 150px;
  transform: rotate(8deg) translateX(10px);
  box-shadow: 0 20px 60px rgba(233, 30, 140, 0.28);
  z-index: 2;
...
.card-float:hover {
  ...
  box-shadow: 0 28px 60px rgba(233, 30, 140, 0.3);
  z-index: 10;
}
...
.about__logo-img {
  ...
  filter: drop-shadow(0 8px 24px rgba(233, 30, 140, 0.25));
}
@keyframes logoPulse {
  0%,
  100% {
...
.admin__upload-placeholder span {
  font-size: 1.8rem;
}
.admin__upload-placeholder p {
  margin: 0;
  font-weight: 500;
}
...
.admin__testimonios-lista {
  margin-top: 28px;
  border-top: 1.5px solid rgba(233, 30, 140, 0.15);
  padding-top: 22px;
}
.admin__lista-titulo {
  font-size: 0.78rem;
...
.comment__form {
  ...
  padding: 32px;
  border: 1.5px solid rgba(233, 30, 140, 0.15);
  box-shadow: 0 8px 32px rgba(233, 30, 140, 0.07);
}
.comment__form h3 {
  font-size: 1.3rem;
  color: var(--text);
...
.comment__admin-empty {
  ...
  background: rgba(233, 30, 140, 0.03);
  border-radius: 16px;
  border: 2px dashed rgba(233, 30, 140, 0.12);
}
.comment__admin-empty span {
  font-size: 3rem;
  opacity: 0.4;
}
.comment__admin-empty p {
  font-size: 0.9rem;
  margin: 0;
}
.comment__admin-list {
...
.comment__admin-item-header strong {
  font-size: 0.92rem;
  color: var(--text);
  display: block;
}
.comment__admin-email {
  font-size: 0.75rem;
  color: var(--text-light);
  display: block;
}
...
.comment__admin-texto {
  ...
  background: #fff;
  border-radius: 12px;
  border-left: 3px solid rgba(233, 30, 140, 0.2);
}
.btn-marcar-leido {
  background: none;
