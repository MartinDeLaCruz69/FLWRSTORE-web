    ...
    <div v-if="visible" class="splash">
      ...
      <div class="splash__content">
        ...
        <div class="splash__bar">
          <div class="splash__progress" :style="{ width: progress + '%' }"></div>
        </div>
      </div>
    </div>
  </Transition>
...
.splash__bg {
  ...
  inset: 0;
  background:
    radial-gradient(ellipse at 20% 50%, rgba(244, 143, 177, 0.3) 0%, transparent 60%),
    radial-gradient(ellipse at 80% 50%, rgba(233, 30, 140, 0.15) 0%, transparent 60%),
    radial-gradient(ellipse at 50% 20%, rgba(252, 228, 236, 0.8) 0%, transparent 70%);
}
