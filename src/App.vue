...
.scroll-top:hover {
  ...
  box-shadow: 0 16px 36px rgba(233,30,140,.45);
}
.scroll-top__icon {
...
.scroll-btn-enter-active { transition: all 0.5s cubic-bezier(.34,1.56,.64,1); }
.scroll-btn-leave-active { transition: all 0.25s ease; }
.scroll-btn-enter-from   { opacity: 0; transform: scale(0.3) translateY(30px); }
.scroll-btn-leave-to     { opacity: 0; transform: scale(0.5) translateY(20px); }
</style>